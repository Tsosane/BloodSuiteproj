...
export const ROUTES = {
  ...
  DONORS_REGISTER: '/donors/register',
...
export const isRouteAccessible = (route, role) => {
  const adminRoutes = [ROUTES.ADMIN_DASHBOARD, ROUTES.ADMIN_USERS, ROUTES.ADMIN_HOSPITALS_PENDING, ROUTES.ADMIN_DATA_IMPORT, ROUTES.DONORS_REGISTER];
  const hospitalRoutes = [ROUTES.HOSPITAL_DASHBOARD, ROUTES.INVENTORY, ROUTES.INVENTORY_ADD, ROUTES.REQUESTS_NEW, ROUTES.REQUESTS_TRACK, ROUTES.REQUESTS_HISTORY, ROUTES.DONORS_NEARBY, ROUTES.DONORS_REGISTER, ROUTES.SETTINGS, ROUTES.HELP];
  ...
  const managerRoutes = [ROUTES.MANAGER_DASHBOARD, ROUTES.ANALYTICS, ROUTES.FORECAST, ROUTES.EXPORT, ROUTES.DONORS_REGISTER, ROUTES.SETTINGS, ROUTES.HELP];
